...
function account({ products }: Props) {
  ...
  const subscription = useSubscription(user); // using my custom hook i created (useSubscription.tsx)
  return (
    <div>
      <Head>
      ...
      <main className="pt-24 mx-auto max-w6xl px-5 pb-12 transition all md:px-10">
